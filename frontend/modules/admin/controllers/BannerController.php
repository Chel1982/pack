...
class BannerController extends Controller
{
    ...
    public function actionStep2(){
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            $this->redirect(Url::to(['/admin/banner']));
        }
        ...
        if($general_image = $model->general_image){
            $image[] =  '<img src="/uploads/banner/' . $model->id . ' " width=250>';
        }

        $path = Yii::getAlias("@frontend/web/uploads/banner/".$model->id);
        $images_add = [];
    ...
    public function actionFileUploadGeneral()
    {
        ...
        if(Yii::$app->request->isPost){
            ...
            $path = Yii::getAlias("@frontend/web/uploads/banner/".$id);
