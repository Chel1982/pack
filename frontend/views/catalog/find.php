                                    ...
                                    <div class="text" style="margin-left: 1.5em">
                                        <?php if ($comV['company_name'] != ''): ?>
                                            <h1><a href="/catalog/vip?id=<?= $comV['id'] ?>"
                                                   style="color: inherit;"><?= \yii\helpers\StringHelper::truncate($comV['company_name'], 50) ?></a>
                                            </h1>
                                        <?php endif; ?>
                                        <div>
                                            <?= StarRating::widget([
                                ...
                                $.ajax({
                                    ...
                                    success: function(data) {
                                        ...
                                        <?php if ($comV['about_company'] != ''): ?>
                                            <p><span></span><?= \yii\helpers\StringHelper::truncate($comV['about_company'], 100) ?></p></p>
                                        <?php endif; ?>
                                    ...
                                    <div class="img">
                                        <?php if ($comP['general_image'] == ''): ?>
                                            <div class="img-container"
                                                ...
                                                <img style="width: 60%;" src="/uploads/logotype/nologo.png" alt="">
                                            </div>
                                        <?php else: ?>
                                            <div class="img-container"
                                                 style="width: 70%; min-height: 100px; height: 60%; margin: 0 auto;">
                                                <img style="width: 60%;"
                                                     src="/uploads/logotype/<?= $comP['general_image'] ?>" alt="">
                                            </div>
                                        <?php endif; ?>
                                    ...
                                    <div class="text">
                                        <?php if ($comP['company_name'] != ''): ?>
                                            <h1><a href="/catalog/pro?id=<?= $comP['id'] ?>"
                                                   style="color: inherit;"><?= \yii\helpers\StringHelper::truncate($comP['company_name'], 50) ?></a>
                                            </h1>
                                        <?php endif; ?>
                                        <div>
                                            <?= StarRating::widget([
                                    ...
                                    <div class="text" style="margin-left: 1.5em">
                                        <?php if ($comS['company_name'] != ''): ?>
                                            <h1><a href="/catalog/start?id=<?= $comS['id'] ?>"
                                                   style="color: inherit;"><?= \yii\helpers\StringHelper::truncate($comS['company_name'], 50) ?></a>
                                            </h1>
                                        <?php endif; ?>
                                        <div>
                                            <?= StarRating::widget([
