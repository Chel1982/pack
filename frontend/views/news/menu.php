                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 m30">
                            <div class="news-small-post" style="width: 262px; height: 254px">
                                <?php if($itemN['general_image'] === null): ?>
                                    <a href=""><img src="/uploads/news/nologo.png" style="width: 262px; height: 142px"></a>
                                <?php else: ?>
                                    <a href=""><img src="/uploads/news/<?= $itemN['id'] ?>/<?= $itemN['general_image'] ?>" style="width: 262px; height: 142px"></a>
                                <?php endif; ?>
